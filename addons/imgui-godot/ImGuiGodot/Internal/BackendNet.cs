...
internal sealed class BackendNet : IBackend
{
    ...
    public void AddFont(FontFile fontData, int fontSize, bool merge, ushort[]? glyphRanges, bool isIcon)
    {
        State.Instance.Fonts.AddFont(fontData, fontSize, merge, glyphRanges, isIcon);
    }

    public void AddFontDefault()
    {
        State.Instance.Fonts.AddFont(null, 13, false, null, false);
    }
